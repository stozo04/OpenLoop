...
| 037 | [A per-identity hold must handle the detector re-labelling the same thing (id churn)](./037-per-identity-hold-must-survive-id-churn.md) | Multi-face lenses review |
