...
- Surfaced during the target-SDK-36 upgrade ([Issue #7](https://github.com/stozo04/OpenLoop/issues/7)); see `ANDROID_STANDARDS.md` §11 and `app/build.gradle.kts` packaging block.
