...
| [`porting-third-party-ar-effects.md`](porting-third-party-ar-effects.md) | **Porting a third-party AR effect into a native lens** — the DeepAR to `Lens.TwistedTongue` worked example: triage, cracking a `.deeparproj`, the translation table, licensing     |
