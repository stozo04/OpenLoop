...
| [Gitleaks](https://github.com/gitleaks/gitleaks) (pinned bootstrap)    | built-in defaults                | Secrets in tracked `HEAD`: API keys, tokens, passwords, signing material, and other credentials; findings are fully redacted                                                                                                               |
...
`*.md` file outside the allowed locations listed in `docs/README.md`. Policy:
