...
3. Read **every core lesson in full: 008 and 011–032.** These are device- and repo-specific (Samsung encoder ordering, surface-size corruption, zero-sample muxes, FGS API gating, CameraX effect attachment) and exist nowhere else.
...
├── review/                      # Play in-app review: the gate constant + the two-call launch
