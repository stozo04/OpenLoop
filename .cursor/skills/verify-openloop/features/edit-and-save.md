...
- Prefer `.cursor/skills/run-e2e-pixel-sweep/scripts/drive-flow.ps1` when `google-pro-fold-video.mp4` is present.
- Otherwise `.cursor/skills/run-e2e/SKILL.md` section 3 (one change per tab) via `control.ps1 tap`.
