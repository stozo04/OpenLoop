...
| Signature                                    | Meaning                                                                                                                                                                                                                                                               |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ensureReversed.timeout` / `Timed out after` | Reverse preview hit the **120 s** `select { onTimeout }` and was canceled → the "Couldn't preview ping-pong — showing forward only" fallback. The emulator's software codec stalls here instead of throwing. Same root cause as the CRASH codecs, different symptom.  |
