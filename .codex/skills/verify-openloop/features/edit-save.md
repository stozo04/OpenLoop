...
- Start logcat before tap (`.codex/skills/run-e2e/scripts/scan-logcat.ps1` afterward).
...
- Orchestrated multi-tab run: [edit-and-save](./edit-and-save.md). Pixel sweep: `.codex/skills/run-e2e-pixel-sweep/`.
